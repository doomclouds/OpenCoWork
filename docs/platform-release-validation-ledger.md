...
| M7 Multi-Agent CoWork | `win-x64` | Pending | 待实施与验证 | 待登记 | Wire 1.2、DAG、Mailbox、Artifact、Worktree、恢复、Secret Canary、进程树与 Dirty Worktree 保留 | [M7 详细设计](superpowers/specs/2026-07-30-open-cowork-m7-multi-agent-cowork-design.md) |
| M7 Multi-Agent CoWork | `osx-arm64` | Pending | 待实施与验证 | 待登记 | Wire 1.2、DAG、Mailbox、Artifact、Worktree、恢复、Secret Canary、进程树与 Dirty Worktree 保留 | [M7 详细设计](superpowers/specs/2026-07-30-open-cowork-m7-multi-agent-cowork-design.md) |
